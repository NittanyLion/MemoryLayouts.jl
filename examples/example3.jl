...
print( styled"{blue:layoutmem (16-byte)}: " )
@btime compute_simd!( s ) setup=( s = layoutmem( create_aligned(); alignment = 16 ) )
print( styled"{blue:layoutmem (32-byte)}: " )
@btime compute_simd!( s ) setup=( s = layoutmem( create_aligned(); alignment = 32 ) )
print( styled"{magenta:layoutmem (64-byte)}: " )
@btime compute_simd!( s ) setup=( s = layoutmem( create_aligned(); alignment = 64 ) )
