...
print( styled"{blue:alignmem (16-byte)}: " )
@btime compute_simd!( s ) setup=( s = alignmem( create_aligned(); alignment = 16 ) )
print( styled"{blue:alignmem (32-byte)}: " )
@btime compute_simd!( s ) setup=( s = alignmem( create_aligned(); alignment = 32 ) )
print( styled"{magenta:alignmem (64-byte)}: " )
@btime compute_simd!( s ) setup=( s = alignmem( create_aligned(); alignment = 64 ) )
