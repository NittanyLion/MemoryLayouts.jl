...
baligned1 = @benchmark computeme!( dataaligned ) setup=( dataaligned = layout( original( N ); alignment = 1 ) )
display( baligned1 )
...
baligned64 = @benchmark computeme!( dataaligned ) setup=( dataaligned = layout( original( N ); alignment = 64 ) )
display( baligned64 )
